    ...
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GradeAndAttendaces", x => x.Id);
                    table.ForeignKey(
                        name: "FK_GradeAndAttendaces_AspNetUsers_StudentUserId",
                        column: x => x.StudentUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GradeAndAttendaces_LessonTimes_LessonTimeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GradeAndAttendaces_LessonTimeId",
                table: "GradeAndAttendaces",
                column: "LessonTimeId");

            migrationBuilder.CreateIndex(
                name: "IX_GradeAndAttendaces_StudentUserId",
                table: "GradeAndAttendaces",
